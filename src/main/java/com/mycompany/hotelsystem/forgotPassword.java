...
public class forgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1266, 19, -1, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 270, 248, -1));

        jTextField2.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 320, 248, -1));

        jTextField3.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 370, 248, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 450, -1, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, -1, -1));

        jPasswordField1.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 410, 250, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon("/Users/stitch/Downloads/Hotel Images & Icon/forgot password.PNG")); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(answer.equals("") || newPassword.equals("")){
            ...
            try{
                if(rs.next()){
                    check = 1; 
                    // Update the data with the new password
                    InsertUpdateDelete.setData("update users set password='"+newPassword+"' "
                                                    + "where email='"+email+"'", "Password Set Successfully");
                    setVisible(false);
